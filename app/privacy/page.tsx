export default function PrivacyPolicy() {
  return (
    <div className="p-8 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      ...
      <p className="mb-4">
        At CrackedLabs LLC, we are committed to protecting your privacy. This Privacy Policy outlines our practices regarding the collection, use, and disclosure of your information when you use our mobile applications.
      </p>
      <h2 className="text-xl font-semibold mb-2">Information We Collect</h2>
      <p className="mb-4">
        We may collect personal information such as your name, email address, and usage data when you use our apps. This information is used to improve our services and provide a better user experience.
      </p>
      <h2 className="text-xl font-semibold mb-2">How We Use Your Information</h2>
      <p className="mb-4">
        The information we collect is used to personalize your experience, improve our applications, and communicate with you. We do not sell or share your personal information with third parties without your consent.
      </p>
